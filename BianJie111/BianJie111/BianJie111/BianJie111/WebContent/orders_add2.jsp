...
<body style="background-image: url(images)">
	...
	<br /><br /><br />
	<table width="969" border="0" align="center" cellpadding="0"
		cellspacing="0">
		<tr>
			...
			<td width="726" valign="top"><table width="700" border="0"
					...
					<tr>
						<td height="455" valign="top" class="content"><html:form
								action="/orders.do?m=add" method="post"
								onsubmit="return checkadd();">
								<p>&nbsp;</p>
								<input name="o_rid" id="o_rid" type="hidden" value="${r_id }" />
								<table width="491" border="0" align="center" cellpadding="1"
