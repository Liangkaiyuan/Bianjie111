...
<div id="wrap">
		...
		<div id="content-wrap">
			...
			<div id="main">
				<h3>添 加</h3>
				<html:form action="/rooms.do?m=add_admin" method="post"  
					enctype="multipart/form-data" onsubmit="return checkadd();">
	        		<p>
					<label>客房名称<span style="color:red">*</span></label>
					<input name="r_name" id="r_name" type="text" size="30" maxlength="20"/>
					<label>图片<span style="color:red">*</span></label>
					<html:file property="imgs"  styleId="imgs"/>
					<label>价格<span style="color:red">*</span></label>
					<input name="r_price" id="r_price"  type="text" size="20" maxlength="20"/>
					<label>床型<span style="color:red">*</span></label>
					<input name="r_bed" id="r_bed"  type="text" size="20" maxlength="20"/>
					<label>早餐<span style="color:red">*</span></label>
					<input name="r_zc" id="r_zc"  type="text" size="20" maxlength="20"/>
					<label>网线<span style="color:red">*</span></label>
					<input name="r_web" id="r_web"  type="text" size="20" maxlength="20"/>
					<label>介绍<span style="color:red">*</span></label>
					 <textarea rows="5" cols="50" id="r_info" name="r_info"></textarea>
					<br />	
