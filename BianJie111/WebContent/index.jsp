...
<h2 class="entry__title">
        ...
        <aside class="col-lg-4 sidebar sidebar--right">
          ...
          <section class="service" id="service">
						...
						<a href="facelogin_users.jsp">用户人脸登录</a>	<br /><br />
						<a href="face_phone.jsp">手机端用户人脸登录</a><br /><br />
						<a href="facelogin_admin.jsp">管理员人脸登录</a>	<br /><br />
							...
							<div class="featured-posts-grid__item featured-posts-grid__item--sm">
								<article class="entry card post-list featured-posts-grid__entry">
									<div class="entry__img-holder post-list__img-holder card__img-holder" style="background-image: url(images/tata.jpg)">
										...
										<a href="rooms.do?m=info&r_id=15" class="entry__meta-category entry__meta-category--label entry__meta-category--align-in-corner entry__meta-category--violet">地板</a>
									</div>

									<div class="entry__body post-list__body card__body">
										<h2 class="entry__title">
                    <a href="rooms.do?m=info&r_id=15"><font size=5>榻榻米房间</font></a>
                  </h2>
										<ul class="entry__meta">
											<li class="entry__meta-author">
												<span>边界艺术馆</span>
							...
							<div class="featured-posts-grid__item featured-posts-grid__item--sm">
								<article class="entry card post-list featured-posts-grid__entry">
									<div class="entry__img-holder post-list__img-holder card__img-holder" style="background-image: url(images/qingxin.jpg)">
										...
										<a href="rooms.do?m=info&r_id=14" class="entry__meta-category entry__meta-category--label entry__meta-category--align-in-corner entry__meta-category--purple">清新舒适</a>
									</div>

									<div class="entry__body post-list__body card__body">
										<h2 class="entry__title">
                    <a href="rooms.do?m=info&r_id=14"><font size=5>清新套间</font></a>
                  </h2>
										<ul class="entry__meta">
											<li class="entry__meta-author">
												<span>边界艺术馆</span>
							...
							<div class="featured-posts-grid__item featured-posts-grid__item--sm">
								<article class="entry card post-list featured-posts-grid__entry">
									<div class="entry__img-holder post-list__img-holder card__img-holder" style="background-image: url(images/fugu.jpg)">
										...
										<a href="rooms.do?m=info&r_id=13" class="entry__meta-category entry__meta-category--label entry__meta-category--align-in-corner entry__meta-category--blue">老式</a>
									</div>

									<div class="entry__body post-list__body card__body">
										<h2 class="entry__title">
                    <a href="rooms.do?m=info&r_id=13"><font size=5>复古套间</font></a>
                  </h2>
										<ul class="entry__meta">
											<li class="entry__meta-author">
												<span>边界艺术馆</span>
                  ...
                  <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/xinwen/about14.jpg');">
                    ...
                    <div class="thumb-text-holder thumb-text-holder--1">   
                      <h2 class="thumb-entry-title">
                        <a href="single-post5.html">“丝绸之路——从写实到写意”</a>
                      </h2>
                      <ul class="entry__meta">
                        <li class="entry__meta-author">
                          <span>by</span>
              ...
              <div class="col-lg-6">
                <article class="entry thumb thumb--size-2">
                  <div class="entry__img-holder thumb__img-holder" style="background-image: url('img/xinwen/about04.jpg');">
                    ...
                    <div class="thumb-text-holder thumb-text-holder--1">   
                      <h2 class="thumb-entry-title">
                        <a href="huodong1.html">边界艺术馆艺术讲堂</a>
                      </h2>
                      <ul class="entry__meta">
                        <li class="entry__meta-author">
                          <span>by</span>
