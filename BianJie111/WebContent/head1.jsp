...
<!-- Bg Overlay -->
  ...
  <header class="sidenav" id="sidenav">
    ...
    <nav class="sidenav__menu-container">
      ...
      <li><a href="face_phone.jsp" class="sidenav__menu-url">手机端用户人脸登录</a></li>
      <li><a href="<%=request.getContextPath() %>/users.do?m=toinsert_face_phone" class="sidenav__menu-url">手机端用户人脸注册</a></li>
      </ul>
    </nav>
          ...
          <div class="flex-parent">
            ...
            <nav class="flex-child nav__wrap d-none d-lg-block">
              ...
              <li class="nav__dropdown">
										<a href="<%=request.getContextPath() %>/rooms.do?m=list" class="ma">边界艺宿</a>
									...
									<li class="nav__dropdown">
										<a href="#">人脸项目</a>
										<ul class="nav__dropdown-menu">	  						
											 <li><a href="facelogin_users.jsp">用户人脸登录</a></li> 
						                          <li><a href="facelogin_admin.jsp">管理员人脸登录</a></li> 
						                         <li> <a href="admin_face_reg.jsp">管理员人脸注册</a></li> 
                                                 <li> <a href="admin/users_login.jsp">密码登录管理员后台</a></li> 
                                                 <li> <a href="face_phone.jsp">手机端用户人脸登录</a></li> 
									...
									<li class="nav__dropdown">
										<a href="comments.do?m=list">在线留言</a>
										<!-- <ul class="nav__dropdown-menu">
									...
									<li class="nav__dropdown">
										...
										<a href="users_login.jsp">普通用户登录</a>	</li>
											...
											<li><a href="<%=request.getContextPath() %>/orders.do?m=list"><span>我的订单</span></a></ul></li>
											
											<%-- <li><a href="<%=request.getContextPath() %>/users.do?m=toupdate_info"><span>修改个人信息</span></a></li>
											<li><a href="<%=request.getContextPath() %>/users.do?m=toinsert_face"><span>本账户人脸注册</span></a></li>
											<li><a href="<%=request.getContextPath() %>/users_pwd.jsp"><span>修改密码</span></a></li>
											<li><a href="<%=request.getContextPath() %>/exit.jsp"><span>退出登录</span></a></li> --%>
